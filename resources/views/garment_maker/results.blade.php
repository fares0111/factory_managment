    ...
    <tbody>
        @foreach($credits as $credit)
            <tr>
                ...
                <td class="edit-delete"><a href="{{route('edit_add_worker', $credit->id)}}">تعديل</a></td>
                <td class="edit-delete"><a href="{{route('delete_add_worker', $credit->id)}}">حذف</a></td>
                @endif
            </tr>
        @endforeach
        <tr>
    ...
    <tbody>
        @foreach($Withdrawals as $Withdrawal)
            <tr>
                ...
                <td class="edit-delete"><a href="{{route('edit_with_worker', $Withdrawal->id)}}">تعديل</a></td>
                <td class="edit-delete"><a href="{{route('delete_with_worker', $Withdrawal->id)}}">حذف</a></td>
                @endif
            </tr>
        @endforeach
    </tbody>
