...
color:red;
    ...
    <h1 id="main">تعديل انتاج صنايعي</h1>
    <meta name="csrf-token" content="{{ csrf_token() }}">
</head>
<body>
    @extends($layout)   

    <form id="expenseForm" method="post" action="{{route('doedit_add_worker',$edit->id)}}">
        @csrf
        ...
        <div class="form-group">
            وصف الموديل
            <input type="text" id="details"  name="ditails" value="{{$edit->ditails}}">
        </div>
        <div class="form-group">
            الملاحظات
