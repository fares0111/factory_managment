...
<form action="{{route("doeditsellwith",$Edit_Purchases_Invoice->id)}}" method="post">
...
<input type="text" name="seller" value="{{$Edit_Purchases_Invoice->seller}}" readonly><br>
...
المبلغ :: <input type="number" name="amont" value="{{$Edit_Purchases_Invoice->amont}}"><br><br>

التايخ :: <input type="date" name="date" value="{{$Edit_Purchases_Invoice->date}}"><br><br>
