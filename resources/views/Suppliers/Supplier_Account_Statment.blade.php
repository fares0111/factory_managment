    ...
    <div class="main-content">
        ...
        <div id="print-section" class="print-section"> 
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">الاجمالي</th>                            
                            <th scope="col">التاريخ</th>
                            <th scope="col">السؤول</th>
                            <th scope="col">الرقم</th>

                        </tr>
                    </thead>
                    <tbody>
                        @foreach($All_Purchases_Returns as $Sales_Return)  
                            <tr>
                                <td>{{ $Sales_Return->type }}</td>
                                <td>{{ $Sales_Return->much }}</td>
                                <td>{{ $Sales_Return->code}}</td>
                                <td>{{ $Sales_Return->total }}</td>
                                <td>{{ date('d-m-Y', strtotime($Sales_Return->date)) }}</td>
                                <td>{{ $Sales_Return->opreator }}</td>
                                <td>{{ $counter++ }}</td>
            ...
            <div class="footer-info">
                <p>المديونية: {{ $Total_Debt }}</p>
                <p>اجمالي المرتجعات: {{ $Total_Returns_Amount }}</p>
                <p>الدفعات: {{ $Total_Payments }}</p>
                <p>الباقي: {{ $Net_Cash }}</p>
            </div>
