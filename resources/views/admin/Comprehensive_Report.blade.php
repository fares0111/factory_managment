...
<body>
    ...
    <div class="form-container">
        <h1>إدخال التاريخ واختيار العضو</h1>

        <form action="{{route('admin/Comprehensive.Report')}}" method="post">
            @csrf
        ...
        @isset($Vodafone_Cash_Deposits)


        @endisset
    </div>

    @if(isset($User_Sales_Report))
    <div class="results-container">
        ...
        <div class="table-container">
            ...
            <table>
                ...
                <tbody>
                    @foreach($User_Sales_Report as $item)
                    <tr>
                        <td>{{ $item->buyer }}</td>
                        <td>{{ $item->price}}</td>
                        <td>{{ $item->much}}</td>
        ...
        <div class="table-container">
            ...
            <table>
                ...
                <tbody>
                    @foreach($User_Sales_Installments_Report  as $item)
                    <tr>
                        <td>{{ $item->buyer }}</td>
                        <td>{{ $item->amont }}</td>
...
<div class="table-container">
    ...
    <table>
        ...
        <tbody>
            @foreach($User_Sales_Returns_Report as $item)
            <tr>
                <td>{{ $item->name }}</td>
                <td>{{ $item->model }}</td>
                <td>{{ $item->much }}</td>
...
<div class="table-container">
    ...
    <table>
        ...
        <tbody>
            @foreach($User_Puraches_Report as $item)
            <tr>
                <td>{{ $item->code }}</td>
                <td>{{ $item->num}}</td>
                <td>{{ $item->price}}</td>
...
<div class="table-container">
    ...
    <table>
        ...
        <tbody>
            @foreach($User_Purchases_Installments_Report  as $item)
            <tr>
                <td>{{ $item->seller }}</td>
                <td>{{ $item->amont }}</td>
                <td>{{ $item->payment_way }}</td>
...
<div class="table-container">
    ...
    <table>
        ...
        <tbody>
            @foreach($User_Purchases_Returns_Report   as $item)
            <tr>
                <td>{{ $item->name }}</td>
                <td>{{ $item->type }}</td>
                <td>{{ $item->much }}</td>
...
<div class="table-container">
    ...
    <table>
        ...
        <!-- إضافة المزيد من الجداول هنا بنفس الطريقة -->
        <!-- يمكنك متابعة نفس الطريقة لتنسيق باقي الجداول -->
    </div>
    @endif
